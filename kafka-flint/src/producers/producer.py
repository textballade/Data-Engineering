...
# sys.path - список папок, в которых Python ищет файлы при import
# insert(0, value) - вставить в начале списка
# Path(__file__) - путь к текущему файлу
# .parent.parent - в данном случае src (чтобы можно было добавить models)

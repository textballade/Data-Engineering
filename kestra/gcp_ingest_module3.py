...
# macos fix, no trusted certificate founded:
# import certifi
...
BUCKET_NAME = "03-homework-v2"

# INITIALIZING CLIENT:
# 1) If GOOGLE_APPLICATION_CREDENTIALS is not set in .env then:
# CREDENTIALS_FILE = "./creds.json"
# client = storage.Client.from_service_account_json(CREDENTIALS_FILE)
# 2) If GOOGLE_APPLICATION_CREDENTIALS is set in .env then:
client = storage.Client(project='terraform-demo-491510')
